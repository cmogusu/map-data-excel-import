...
*                                                                     *
* Adds various Methods to window.google.maps.Polygon and window.google.maps.Polyline *
*                                                                     *
...
// === Returns null if the path is shorter than the specified distance ===
window.google.maps.Polygon.prototype.GetIndexAtDistance = function(metres) {
  // some awkward special cases
  if (metres == 0) return this.getPath().getAt(0);
  if (metres < 0) return null;
  var dist=0;
...
window.google.maps.Polygon.prototype.Bearing = function(v1,v2) {
  if (v1 == null) {
    v1 = 0;
